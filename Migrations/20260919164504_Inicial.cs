        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Categoria_ValorDiariaBase", "[ValorDiariaBase] > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Aluguel_DataDevolucao", "[DataDevolucao] IS NULL OR [DataDevolucao] >= [DataRetirada]");
                    table.CheckConstraint("CK_Aluguel_KmFinal", "[KmFinal] IS NULL OR [KmFinal] >= [KmInicial]");
                    table.CheckConstraint("CK_Aluguel_PrevistaDevolucao", "[DataPrevistaDevolucao] >= [DataRetirada]");
